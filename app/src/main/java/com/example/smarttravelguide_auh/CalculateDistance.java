...
public class CalculateDistance extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    public String makeURL (double sourcelat, double sourcelog, double destlat, double destlog ){
        ...
        urlString.append("&key=AIzaSyClqM8ZikuXsJdb_0M8qVm_z2CJmxeBVnQ");
    ...
    public void drawPath(String  result) {
        ...
        try {
            ...
            Toast.makeText(this,"There's some error!",Toast.LENGTH_SHORT).show();
        }
    }
